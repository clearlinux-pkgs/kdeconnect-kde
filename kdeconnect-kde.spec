...
#
# Source0 file verified with key 0x9914CFDA645D751B (nicolas.fella@kdab.com)
#
Name     : kdeconnect-kde
Version  : 1.4.1
Release  : 5
URL      : https://download.kde.org/stable/kdeconnect/1.4.1/kdeconnect-kde-1.4.1.tar.xz
Source0  : https://download.kde.org/stable/kdeconnect/1.4.1/kdeconnect-kde-1.4.1.tar.xz
Source1  : https://download.kde.org/stable/kdeconnect/1.4.1/kdeconnect-kde-1.4.1.tar.xz.sig
...
%prep
%setup -q -n kdeconnect-kde-1.4.1
cd %{_builddir}/kdeconnect-kde-1.4.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1602993550
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdeconnect-kde-1.4.1/COPYING %{buildroot}/usr/share/package-licenses/kdeconnect-kde/4cc77b90af91e615a64ae04893fdffa7939db84c
pushd clr-build
%make_install
popd
...
/usr/lib64/libkdeconnectcore.so.1.4.1
/usr/lib64/libkdeconnectinterfaces.so.1
/usr/lib64/libkdeconnectinterfaces.so.1.4.1
/usr/lib64/libkdeconnectpluginkcm.so.1
/usr/lib64/libkdeconnectpluginkcm.so.1.4.1
/usr/lib64/libkdeconnectsmshelper.so.1
/usr/lib64/libkdeconnectsmshelper.so.1.4.1
