...
Version  : 24.02.2
Release  : 50
URL      : https://download.kde.org/stable/release-service/24.02.2/src/kdeconnect-kde-24.02.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.02.2/src/kdeconnect-kde-24.02.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.2/src/kdeconnect-kde-24.02.2.tar.xz.sig
...
%setup -q -n kdeconnect-kde-24.02.2
cd %{_builddir}/kdeconnect-kde-24.02.2
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1712935593
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkdeconnectcore.so.24.02.2
/V3/usr/lib64/libkdeconnectpluginkcm.so.24.02.2
...
/usr/lib64/libkdeconnectcore.so.24.02.2
/usr/lib64/libkdeconnectpluginkcm.so.24
/usr/lib64/libkdeconnectpluginkcm.so.24.02.2
