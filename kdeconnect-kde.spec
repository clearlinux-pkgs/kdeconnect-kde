...
Version  : 25.04.1
Release  : 68
URL      : https://download.kde.org/stable/release-service/25.04.1/src/kdeconnect-kde-25.04.1.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.1/src/kdeconnect-kde-25.04.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.1/src/kdeconnect-kde-25.04.1.tar.xz.sig
...
%setup -q -n kdeconnect-kde-25.04.1
cd %{_builddir}/kdeconnect-kde-25.04.1
pushd ..
cp -a kdeconnect-kde-25.04.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747156455
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkdeconnectcore.so.25.04.1
/V3/usr/lib64/libkdeconnectpluginkcm.so.25.04.1
...
/usr/lib64/libkdeconnectcore.so.25.04.1
/usr/lib64/libkdeconnectpluginkcm.so.25
/usr/lib64/libkdeconnectpluginkcm.so.25.04.1
