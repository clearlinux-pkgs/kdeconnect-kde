...
Source0  : https://download.kde.org/stable/release-service/24.02.0/src/kdeconnect-kde-24.02.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.02.0/src/kdeconnect-kde-24.02.0.tar.xz.sig
...
%prep
%setup -q -n kdeconnect-kde-24.02.0
cd %{_builddir}/kdeconnect-kde-24.02.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1710518135
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkdeconnectcore.so.24.02.0
/V3/usr/lib64/libkdeconnectpluginkcm.so.24.02.0
...
/usr/lib64/libkdeconnectcore.so.24.02.0
/usr/lib64/libkdeconnectpluginkcm.so.24
/usr/lib64/libkdeconnectpluginkcm.so.24.02.0
