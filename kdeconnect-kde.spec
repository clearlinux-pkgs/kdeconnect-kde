...
Version  : 20.08.3
Release  : 6
URL      : https://download.kde.org/stable/release-service/20.08.3/src/kdeconnect-kde-20.08.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/20.08.3/src/kdeconnect-kde-20.08.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/20.08.3/src/kdeconnect-kde-20.08.3.tar.xz.sig
...
%prep
%setup -q -n kdeconnect-kde-20.08.3
cd %{_builddir}/kdeconnect-kde-20.08.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1605904997
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdeconnect-kde-20.08.3/COPYING %{buildroot}/usr/share/package-licenses/kdeconnect-kde/4cc77b90af91e615a64ae04893fdffa7939db84c
pushd clr-build
%make_install
popd
