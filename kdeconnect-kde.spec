...
Source0  : https://download.kde.org/stable/release-service/24.05.2/src/kdeconnect-kde-24.05.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.05.2/src/kdeconnect-kde-24.05.2.tar.xz.sig
...
%setup -q -n kdeconnect-kde-24.05.2
cd %{_builddir}/kdeconnect-kde-24.05.2
pushd ..
cp -a kdeconnect-kde-24.05.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1720592676
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkdeconnectcore.so.24.05.2
/V3/usr/lib64/libkdeconnectpluginkcm.so.24.05.2
...
/usr/lib64/libkdeconnectcore.so.24.05.2
/usr/lib64/libkdeconnectpluginkcm.so.24
/usr/lib64/libkdeconnectpluginkcm.so.24.05.2
