...
Version  : 22.12.3
Release  : 34
URL      : https://download.kde.org/stable/release-service/22.12.3/src/kdeconnect-kde-22.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/22.12.3/src/kdeconnect-kde-22.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.12.3/src/kdeconnect-kde-22.12.3.tar.xz.sig
...
%prep
%setup -q -n kdeconnect-kde-22.12.3
cd %{_builddir}/kdeconnect-kde-22.12.3
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1677793952
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libkdeconnectcore.so.22.12.3
/usr/lib64/libkdeconnectinterfaces.so.22
/usr/lib64/libkdeconnectinterfaces.so.22.12.3
/usr/lib64/libkdeconnectpluginkcm.so.22
/usr/lib64/libkdeconnectpluginkcm.so.22.12.3
