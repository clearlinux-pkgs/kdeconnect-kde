...
Source0  : https://download.kde.org/stable/release-service/25.04.0/src/kdeconnect-kde-25.04.0.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.0/src/kdeconnect-kde-25.04.0.tar.xz.sig
...
%setup -q -n kdeconnect-kde-25.04.0
cd %{_builddir}/kdeconnect-kde-25.04.0
pushd ..
cp -a kdeconnect-kde-25.04.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1744937810
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkdeconnectcore.so.25.04.0
/V3/usr/lib64/libkdeconnectpluginkcm.so.25.04.0
...
/usr/lib64/libkdeconnectcore.so.25.04.0
/usr/lib64/libkdeconnectpluginkcm.so.25
/usr/lib64/libkdeconnectpluginkcm.so.25.04.0
