...
Version  : 25.04.2
Release  : 69
URL      : https://download.kde.org/stable/release-service/25.04.2/src/kdeconnect-kde-25.04.2.tar.xz
Source0  : https://download.kde.org/stable/release-service/25.04.2/src/kdeconnect-kde-25.04.2.tar.xz
Source1  : https://download.kde.org/stable/release-service/25.04.2/src/kdeconnect-kde-25.04.2.tar.xz.sig
...
%setup -q -n kdeconnect-kde-25.04.2
cd %{_builddir}/kdeconnect-kde-25.04.2
pushd ..
cp -a kdeconnect-kde-25.04.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1749517182
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/kdeconnect-kde-%{version}/LICENSES/GPL-3.0-or-later.txt %{buildroot}/usr/share/package-licenses/kdeconnect-kde/d731920113454e58292b53feedd262e531cae0f1 || :
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkdeconnectcore.so.25.04.2
/V3/usr/lib64/libkdeconnectpluginkcm.so.25.04.2
...
/usr/lib64/libkdeconnectcore.so.25
/usr/lib64/libkdeconnectcore.so.25.04.2
/usr/lib64/libkdeconnectpluginkcm.so.25
/usr/lib64/libkdeconnectpluginkcm.so.25.04.2
...
/usr/share/package-licenses/kdeconnect-kde/d731920113454e58292b53feedd262e531cae0f1
