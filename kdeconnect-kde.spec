...
%setup -q -n kdeconnect-kde-24.08.2
cd %{_builddir}/kdeconnect-kde-24.08.2
pushd ..
cp -a kdeconnect-kde-24.08.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1728615952
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkdeconnectcore.so.24.08.2
/V3/usr/lib64/libkdeconnectpluginkcm.so.24.08.2
...
/usr/lib64/libkdeconnectcore.so.24.08.2
/usr/lib64/libkdeconnectpluginkcm.so.24
/usr/lib64/libkdeconnectpluginkcm.so.24.08.2
