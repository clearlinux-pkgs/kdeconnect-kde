...
Source0  : https://download.kde.org/stable/release-service/23.08.5/src/kdeconnect-kde-23.08.5.tar.xz
Source1  : https://download.kde.org/stable/release-service/23.08.5/src/kdeconnect-kde-23.08.5.tar.xz.sig
...
%prep
%setup -q -n kdeconnect-kde-23.08.5
cd %{_builddir}/kdeconnect-kde-23.08.5
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1708412432
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkdeconnectcore.so.23.08.5
/V3/usr/lib64/libkdeconnectinterfaces.so.23.08.5
/V3/usr/lib64/libkdeconnectpluginkcm.so.23.08.5
...
/usr/lib64/libkdeconnectcore.so.23.08.5
/usr/lib64/libkdeconnectinterfaces.so.23
/usr/lib64/libkdeconnectinterfaces.so.23.08.5
/usr/lib64/libkdeconnectpluginkcm.so.23
/usr/lib64/libkdeconnectpluginkcm.so.23.08.5
