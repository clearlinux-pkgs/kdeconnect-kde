...
%prep
%setup -q -n kdeconnect-kde-22.12.2
cd %{_builddir}/kdeconnect-kde-22.12.2
...
/usr/lib64/libkdeconnectcore.so.22.12.2
/usr/lib64/libkdeconnectinterfaces.so.22
/usr/lib64/libkdeconnectinterfaces.so.22.12.2
/usr/lib64/libkdeconnectpluginkcm.so.22
/usr/lib64/libkdeconnectpluginkcm.so.22.12.2
