...
Version  : 24.12.3
Release  : 66
URL      : https://download.kde.org/stable/release-service/24.12.3/src/kdeconnect-kde-24.12.3.tar.xz
Source0  : https://download.kde.org/stable/release-service/24.12.3/src/kdeconnect-kde-24.12.3.tar.xz
Source1  : https://download.kde.org/stable/release-service/24.12.3/src/kdeconnect-kde-24.12.3.tar.xz.sig
...
%setup -q -n kdeconnect-kde-24.12.3
cd %{_builddir}/kdeconnect-kde-24.12.3
pushd ..
cp -a kdeconnect-kde-24.12.3 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742485984
mkdir -p clr-build
pushd clr-build
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/libkdeconnectcore.so.24.12.3
/V3/usr/lib64/libkdeconnectpluginkcm.so.24.12.3
...
/usr/lib64/libkdeconnectcore.so.24.12.3
/usr/lib64/libkdeconnectpluginkcm.so.24
/usr/lib64/libkdeconnectpluginkcm.so.24.12.3
