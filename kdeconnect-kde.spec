...
Source0  : https://download.kde.org/stable/release-service/22.08.1/src/kdeconnect-kde-22.08.1.tar.xz
Source1  : https://download.kde.org/stable/release-service/22.08.1/src/kdeconnect-kde-22.08.1.tar.xz.sig
...
%prep
%setup -q -n kdeconnect-kde-22.08.1
cd %{_builddir}/kdeconnect-kde-22.08.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662783878
mkdir -p clr-build
pushd clr-build
...
/usr/lib64/libkdeconnectcore.so.22.08.1
/usr/lib64/libkdeconnectinterfaces.so.22
/usr/lib64/libkdeconnectinterfaces.so.22.08.1
/usr/lib64/libkdeconnectpluginkcm.so.22
/usr/lib64/libkdeconnectpluginkcm.so.22.08.1
